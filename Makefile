...
# Generated by qmake (2.01a) (Qt 4.8.6) on: Mon May 11 19:41:46 2015
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/fluids3d1.0.0/ && $(COPY_FILE) --parents mainwindow.h glpanel.h controller.h simulation.h simparameters.h vectormath.h camera.h rotator.h fluid.h .tmp/fluids3d1.0.0/ && $(COPY_FILE) --parents main.cpp mainwindow.cpp glpanel.cpp controller.cpp simulation.cpp simparameters.cpp vectormath.cpp camera.cpp rotator.cpp fluid.cpp .tmp/fluids3d1.0.0/ && $(COPY_FILE) --parents mainwindow.ui .tmp/fluids3d1.0.0/ && (cd `dirname .tmp/fluids3d1.0.0` && $(TAR) fluids3d1.0.0.tar fluids3d1.0.0 && $(COMPRESS) fluids3d1.0.0.tar) && $(MOVE) `dirname .tmp/fluids3d1.0.0`/fluids3d1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/fluids3d1.0.0
