#############################################################################
# Makefile for building: fluids3d
# Generated by qmake (2.01a) (Qt 4.8.6) on: Tue May 5 18:41:16 2015
# Project:  fluids3d.pro
# Template: app
# Command: /usr/lib/x86_64-linux-gnu/qt4/bin/qmake -spec /usr/share/qt4/mkspecs/linux-g++ -o Makefile fluids3d.pro
#############################################################################
...
LINK          = g++
LFLAGS        = -Wl,-O1
LIBS          = $(SUBLIBS)  -L/usr/lib/x86_64-linux-gnu -L/usr/X11R6/lib -lGLU -L/v/filer4b/v20q001/gill/CG384/Final_project/fluids3d/SOIL/lib -lSOIL -lQtOpenGL -lQtGui -lQtCore -lGL -lpthread 
AR            = ar cqs
RANLIB        = 
...
Makefile: fluids3d.pro  /usr/share/qt4/mkspecs/linux-g++/qmake.conf /usr/share/qt4/mkspecs/common/unix.conf \
		/usr/share/qt4/mkspecs/common/linux.conf \
		/usr/share/qt4/mkspecs/common/gcc-base.conf \
		/usr/share/qt4/mkspecs/common/gcc-base-unix.conf \
		/usr/share/qt4/mkspecs/common/g++-base.conf \
	...
	$(QMAKE) -spec /usr/share/qt4/mkspecs/linux-g++ -o Makefile fluids3d.pro
...
dist: 
	@$(CHK_DIR_EXISTS) .tmp/fluids3d1.0.0 || $(MKDIR) .tmp/fluids3d1.0.0 
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/fluids3d1.0.0/ && $(COPY_FILE) --parents mainwindow.h glpanel.h controller.h simulation.h simparameters.h mesh.h rigidbodytemplate.h rigidbodyinstance.h vectormath.h camera.h rotator.h collisions/Distance.h collisions/CTCD.h quadprog/eiquadprog.hpp fluid.h .tmp/fluids3d1.0.0/ && $(COPY_FILE) --parents main.cpp mainwindow.cpp glpanel.cpp controller.cpp simulation.cpp simparameters.cpp mesh.cpp rigidbodytemplate.cpp rigidbodyinstance.cpp vectormath.cpp camera.cpp rotator.cpp collisions/CTCD.cpp fluid.cpp .tmp/fluids3d1.0.0/ && $(COPY_FILE) --parents mainwindow.ui .tmp/fluids3d1.0.0/ && (cd `dirname .tmp/fluids3d1.0.0` && $(TAR) fluids3d1.0.0.tar fluids3d1.0.0 && $(COMPRESS) fluids3d1.0.0.tar) && $(MOVE) `dirname .tmp/fluids3d1.0.0`/fluids3d1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/fluids3d1.0.0
...
libSOIL:
	cd /v/filer4b/v20q001/gill/CG384/Final_project/fluids3d/SOIL/projects/makefile/ && make
